        ...
        >
          <DialogHeader>
            <DialogTitle textAlign="center" w="100%">
              <LayoutTitle fontSize={{ base: '2rem', md: '4rem' }} />
            </DialogTitle>
          </DialogHeader>
          <DialogBody>
            <Stack align="center">
            ...
            <Text textStyle="body" textAlign="center">
              <Box mb="1rem">Hi! I'm Vinyasa Buddy.</Box>
              Please remember: I'm not a human and am here just to help you
              remember each posture.
          ...
          <DialogFooter justifyContent="center" mt="0.5rem">
            <Stack gap="1.5rem" align="center">
              ...
              >
                ...
                <Checkbox.Label fontSize="2rem" color="textPrimary">
